...
#Install BadVPN
# install badvpn
wget -O /usr/bin/badvpn-udpgw "http://sourceforge.net/projects/narrundo/files/conf/badvpn-udpgw"
...
cd /etc/openvpn/
wget -O /etc/openvpn/1194-client.ovpn "http://sourceforge.net/projects/narrundo/files/conf/1194.conf"
...
echo "OpenVPN  : http://$IP/client.tar"
